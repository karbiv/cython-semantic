...
;; Created: 2016-11-09 23:32:14+0200
;; Keywords: syntax
;; X-RCS: $Id$
...
(defconst cython-wy--parse-table
  (progn
	...
	((DEF NAME parameters COLON suite)
	 (cython-reconstitute-function-tag
	  (wisent-raw-tag
	   (semantic-tag-new-function $2 nil
				      (semantic-tag-get-attribute
				       (car $3)
				       :args)
				      :def 'def))
